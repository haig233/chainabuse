...
# Saves data directly to repository
# ============================================
...
# Configuration
output_dir = 'chainabuse_data-ETH-First-10-Page-2nd-Time/'
...
async def scrape_all_github(all_urls, batch_size=50, max_concurrent=5, checkpoint_interval=250, max_retries=2):
...
async def main():
    ...
    # urls_list = [f'https://chainabuse.com/chain/ETH?page={i}' for i in range(5000, 10000)] 
    # urls_list = [f'https://chainabuse.com/chain/ETH?page={i}' for i in range(9900, 12401)]
